...
const STEPS: Step[] = [
  ...
  { key: 'scroll', title: 'Scroll',
    instr: 'In the open WebView, drag up and down. PASS if the page scrolls and tracks your finger; FAIL if it does not move.' },
  { key: 'click', title: 'Tap / click',
    instr: 'Tap a link or button inside the frame. PASS if it responds (highlights, navigates, opens something); FAIL if taps do nothing.' },
